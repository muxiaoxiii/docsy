<template>
  <div class="fn-row">
    ...
    <div v-if="datePopover" class="fn-popover" @mousedown.prevent>
    ...
    <div v-if="seqPopover" class="fn-popover" @mousedown.prevent>
...
const previewText = computed(() => {
  ...
  const name = tokens.map((t) => {
    ...
    if (t.type === 'preset') {
      ...
      if (t.value === '日期-') return todayDash()
      if (t.value === '日期短') return todayShort()
